...
public class ModelTodosAdapter extends BaseAdapter {

    private final List<ModelTodos> lista;
    private final Activity act;

    public ModelTodosAdapter(List<ModelTodos> lista, Activity act) {
        this.lista = lista;
        this.act = act;
    }
    ...
    public View getView(int position, View View, ViewGroup parent){
        ...
        ModelTodos todos = lista.get(position);
